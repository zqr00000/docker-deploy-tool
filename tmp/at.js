...
WARNING: This link could potentially be dangerous`)) {
  ...
  // src/renderer/pages/agent/AgentTerminal.tsx
  ...
  // src/renderer/agent/persistence-manager.ts
  var PersistenceManager = class _PersistenceManager {
    ...
    // 更新会话索引
    async updateSessionIndex(sessionId, name) {
      const key = "session-index";
      const index = this.getSessionIndex();
      const existingIndex = index.findIndex((item) => item.id === sessionId);
      if (existingIndex >= 0) {
        index[existingIndex] = { id: sessionId, name, updatedAt: (/* @__PURE__ */ new Date()).toISOString() };
      } else {
        index.unshift({ id: sessionId, name, updatedAt: (/* @__PURE__ */ new Date()).toISOString() });
      }
    ...
    // 加载配置
    async loadConfig(key, defaultValue) {
      try {
...
\u8BF7\u6839\u636E\u7528\u6237\u9700\u6C42\u63D0\u4F9B\u4E13\u4E1A\u7684\u670D\u52A1\u5668\u8FD0\u7EF4\u5EFA\u8BAE\u3002`,
  ...
  var CONFIG_KEY = "agentOpsModelConfig";
  var renderMarkdown = (content) => {
    return content.replace(/```(\w*)\n([\s\S]*?)```/g, '<pre style="background:#000000;padding:12px;border-radius:6px;overflow:auto;border:1px solid #48484a;margin:8px 0;"><code style="color:#f5f5f7;font-family:monospace;font-size:12px;">$2</code></pre>').replace(/`([^`]+)`/g, '<code style="background:#3a3a3c;padding:2px 6px;border-radius:4px;color:#f5f5f7;font-family:monospace;font-size:12px;">$1</code>').replace(/\*\*([^*]+)\*\*/g, '<strong style="color:#fff;">$1</strong>').replace(/\*([^*]+)\*/g, '<em style="color:#aeaeb2;">$1</em>').replace(/^### (.+)$/gm, '<h3 style="color:#fff;margin:12px 0 6px;font-size:14px;">$1</h3>').replace(/^## (.+)$/gm, '<h2 style="color:#fff;margin:16px 0 8px;font-size:16px;">$1</h2>').replace(/^# (.+)$/gm, '<h1 style="color:#fff;margin:20px 0 10px;font-size:18px;">$1</h1>').replace(/^\- (.+)$/gm, '<li style="margin:4px 0 4px 16px;color:#f5f5f7;">$1</li>').replace(/\n/g, "<br/>");
  };
  var buildCommandList = (text, toolCalls) => {
    const out = [];
    const push = (cmd) => {
      const c = cmd.trim();
  ...
  var renderRichSegment = (text, onCopy, onExecute, canExecute) => {
    const parts = text.split(/(```[\s\S]*?```)/g);
    return parts.map((part, i) => {
      const m = part.match(/^```(?:bash|sh|shell)?\s*\n([\s\S]*?)```$/);
      if (m && m[1].trim()) {
        const cmd = m[1].replace(/\n\s*$/, "").trim();
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "inline-cmd", style: { margin: "6px 0" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { style: { margin: 0, padding: 10, borderRadius: 6, background: "#000000", border: "1px solid #3a3a3c", fontSize: 12, color: "#30D158", overflow: "auto", fontFamily: "Consolas, monospace", whiteSpace: "pre-wrap" }, children: cmd }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 4, marginTop: 6 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", type: "text", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CopyOutlined, {}), onClick: () => onCopy && onCopy(cmd), style: { color: "#aeaeb2" }, children: "\u590D\u5236" }),
            onExecute && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", type: "text", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.PlayCircleOutlined, {}), disabled: !canExecute, onClick: () => onExecute(cmd), style: { color: "#0A84FF" }, children: "\u5728\u7EC8\u7AEF\u6267\u884C" })
          ] })
        ] }, i);
      }
      if (!part.trim()) return null;
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { dangerouslySetInnerHTML: { __html: renderMarkdown(part) } }, i);
    });
  };
  var ToolCallCard = ({ tc }) => {
    const isRunning = tc.status === "running";
    const icon = isRunning ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Spin, { size: "small" }) : tc.status === "success" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CheckCircleOutlined, { style: { color: "#30D158" } }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CloseCircleOutlined, { style: { color: "#FF453A" } });
    const tagColor = tc.status === "success" ? "green" : tc.status === "error" ? "red" : "blue";
    const tagText = isRunning ? "\u6267\u884C\u4E2D" : tc.status === "success" ? "\u6210\u529F" : "\u5931\u8D25";
    const favCommand = typeof tc.params?.command === "string" ? tc.params.command : void 0;
    const [favorited, setFavorited] = (0, import_react.useState)(() => favCommand ? isFavoriteCommand(favCommand) : false);
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "tool-card", style: { background: "rgba(0,0,0,0.6)", padding: 10, borderRadius: 10, border: "1px solid #3a3a3c" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        icon,
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CodeOutlined, { style: { color: "#0A84FF" } }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { color: "#0A84FF", fontSize: 12, flex: 1, fontFamily: "SF Mono, Consolas, monospace" }, children: tc.name }),
        tc.duration !== void 0 && !isRunning && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, { type: "secondary", style: { fontSize: 11 }, children: [
          tc.duration,
          "ms"
        ] }),
        favCommand && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title: favorited ? "\u53D6\u6D88\u6536\u85CF" : "\u6536\u85CF\u6B64\u547D\u4EE4", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          import_antd.Button,
          {
            size: "small",
            type: "text",
            icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.StarOutlined, { style: { color: favorited ? "#FF9500" : "#636366" } }),
            style: { padding: 0, width: 20, height: 20 },
            onClick: () => {
              const f = toggleFavoriteCommand(favCommand, tc.name);
              setFavorited(f);
            }
          }
        ) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tag, { color: tagColor, style: { fontSize: 10, margin: 0, borderRadius: 999 }, children: tagText })
      ] }),
      !isRunning && tc.result && typeof tc.result === "string" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ResourceBars, { text: tc.result }),
      !isRunning && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { style: { margin: "8px 0 0 0", maxHeight: 160, overflow: "auto", fontSize: 11, color: "#aeaeb2", background: "rgba(28,28,30,0.5)", padding: 8, borderRadius: 6, whiteSpace: "pre-wrap", border: "1px solid #3a3a3c" }, children: tc.result })
    ] });
  };
  var FAVORITES_KEY = "agentFavoriteCommands";
  var FAVORITES_EVENT = "agent-favorites-changed";
  ...
  function isFavoriteCommand(command) {
    return getFavoriteCommands().some((f) => f.command === command);
  }
  function toggleFavoriteCommand(command, name) {
    ...
    if (exists >= 0) {
      ...
      next = [{ command, name, createdAt: (/* @__PURE__ */ new Date()).toISOString() }, ...list];
    }
    localStorage.setItem(FAVORITES_KEY, JSON.stringify(next));
    window.dispatchEvent(new CustomEvent(FAVORITES_EVENT));
    return exists < 0;
  }
  var parseResourceMetrics = (text) => {
    const metrics = [];
  ...
  var ResourceBars = ({ text }) => {
    const metrics = parseResourceMetrics(text);
    if (metrics.length === 0) return null;
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { margin: "8px 0 0 0", display: "flex", flexDirection: "column", gap: 5, padding: "6px 10px", background: "rgba(28,28,30,0.5)", borderRadius: 6, border: "1px solid #3a3a3c" }, children: metrics.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { fontSize: 11, color: "#aeaeb2", width: 32, flexShrink: 0 }, children: m.label }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1, height: 6, background: "#3a3a3c", borderRadius: 3, overflow: "hidden" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: `${Math.min(m.value, 100)}%`, height: "100%", background: m.value > 90 ? "#FF453A" : m.value > 75 ? "#FF9500" : "#30D158", borderRadius: 3, transition: "width 0.3s" } }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, { style: { fontSize: 11, color: m.value > 90 ? "#FF453A" : m.value > 75 ? "#FF9500" : "#30D158", width: 42, textAlign: "right", flexShrink: 0 }, children: [
        m.value.toFixed(1),
        "%"
      ] })
    ] }, m.label)) });
  ...
  var AgentTerminalPage = () => {
    const { modal } = import_antd.App.useApp();
    const [servers, setServers] = (0, import_react.useState)([]);
    const [selectedServer, setSelectedServer] = (0, import_react.useState)(void 0);
    const [connected, setConnected] = (0, import_react.useState)(false);
    const [containers, setContainers] = (0, import_react.useState)([]);
    const [loadingContainers, setLoadingContainers] = (0, import_react.useState)(false);
    ...
    const [activeSessionId, setActiveSessionId] = (0, import_react.useState)(void 0);
    ...
    const [favorites, setFavorites] = (0, import_react.useState)(getFavoriteCommands);
    (0, import_react.useEffect)(() => {
      const handler = () => setFavorites(getFavoriteCommands());
      window.addEventListener(FAVORITES_EVENT, handler);
      return () => window.removeEventListener(FAVORITES_EVENT, handler);
    }, []);
    const [terminalThemeId, setTerminalThemeId] = (0, import_react.useState)(() => localStorage.getItem("agentTerminalTheme") || "github-dark");
    const [modelConfig, setModelConfig] = (0, import_react.useState)(() => {
      const saved = localStorage.getItem(CONFIG_KEY);
      const parsed = saved ? JSON.parse(saved) : DEFAULT_MODEL_CONFIG;
      return ensureProfiles(parsed);
    });
    const [terminalTabs, setTerminalTabs] = (0, import_react.useState)([]);
    const [activeTerminalTab, setActiveTerminalTab] = (0, import_react.useState)("");
    const [openNewModal, setOpenNewModal] = (0, import_react.useState)(false);
    const [selectedContainerId, setSelectedContainerId] = (0, import_react.useState)();
    const tabsRef = (0, import_react.useRef)(terminalTabs);
    const terminalContainersRef = (0, import_react.useRef)(/* @__PURE__ */ new Map());
    const terminalInstancesRef = (0, import_react.useRef)(/* @__PURE__ */ new Map());
    const fitAddonsRef = (0, import_react.useRef)(/* @__PURE__ */ new Map());
    const terminalAreaRef = (0, import_react.useRef)(null);
    const fitAndFill = (container, term, fit) => {
      ...
      if (sw > 0 && winW > sw) {
        ...
        if (extra > 0 && term.cols + extra <= 1e3) term.resize(term.cols + extra, term.rows);
      }
    };
    const [terminalMode, setTerminalMode] = (0, import_react.useState)("server");
    ...
    const [runningDiagnostics, setRunningDiagnostics] = (0, import_react.useState)(false);
    const [approvalQueue, setApprovalQueue] = (0, import_react.useState)([]);
    const [approvalCountdown, setApprovalCountdown] = (0, import_react.useState)(0);
    const currentApproval = approvalQueue.length > 0 ? approvalQueue[0] : null;
    const currentRequestIdRef = (0, import_react.useRef)(null);
    ...
    const loadServers = (0, import_react.useCallback)(async () => {
      try {
    ...
    const loadContainers = (0, import_react.useCallback)(async (serverId) => {
      ...
      try {
        ...
        import_antd.message.error("\u52A0\u8F7D\u5BB9\u5668\u5931\u8D25");
      } finally {
    ...
    const handleServerChange = async (serverId) => {
      ...
      if (server) {
        try {
          ...
          if (!result.success) {
            import_antd.message.warning(`\u670D\u52A1\u5668\u8FDE\u63A5\u5931\u8D25: ${result.message}`);
          }
        } catch (error) {
          setConnected(false);
          import_antd.message.warning(`\u670D\u52A1\u5668\u8FDE\u63A5\u5931\u8D25: ${error.message}`);
        }
      }
    ...
    const createSession = async () => {
      const session = {
        id: `session-${Date.now()}`,
        name: `\u5BF9\u8BDD ${(/* @__PURE__ */ new Date()).toLocaleString()}`,
        messages: [],
    ...
    const deleteSession = async (sessionId) => {
      ...
      if (activeSessionId === sessionId) {
        ...
        setActiveSessionId(remaining.length > 0 ? remaining[0].id : void 0);
      }
      await loadSessions();
    };
    const duplicateSession = async (sessionId) => {
      ...
      import_antd.message.success("\u4F1A\u8BDD\u5DF2\u590D\u5236");
    };
    const filteredSessions = (0, import_react.useMemo)(() => {
      const q = sessionSearch.trim().toLowerCase();
      if (!q) return sessions;
      return sessions.filter(
        (s) => s.name.toLowerCase().includes(q) || s.messages.some((m) => (m.content || "").toLowerCase().includes(q))
      );
    ...
    const renameSession = async () => {
      ...
      import_antd.message.success("\u4F1A\u8BDD\u5DF2\u91CD\u547D\u540D");
    };
    ...
    const persistSession = (0, import_react.useCallback)((msgs) => {
      if (!activeSessionId) return;
      persistenceManager.saveSession({
        id: activeSessionId,
        name: sessions.find((s) => s.id === activeSessionId)?.name || `\u5BF9\u8BDD ${(/* @__PURE__ */ new Date()).toLocaleString()}`,
        messages: msgs,
        createdAt: (/* @__PURE__ */ new Date()).toISOString(),
        updatedAt: (/* @__PURE__ */ new Date()).toISOString()
      });
    ...
    (0, import_react.useEffect)(() => {
      const decryptAll = async () => {
        ...
        if ((cfg.providerProfiles || []).some((p) => p.apiKey.startsWith("enc:"))) {
          const profiles2 = await Promise.all((cfg.providerProfiles || []).map(async (p) => {
          ...
          cfg = { ...cfg, providerProfiles: profiles2 };
        }
        setModelConfig(cfg);
      };
      decryptAll().catch(() => {
    ...
    const clearMessages = () => {
      setMessages([]);
      setSavePending(true);
      import_antd.message.success("\u5BF9\u8BDD\u5DF2\u6E05\u7A7A");
    };
    const sendMessage = async () => {
      if (!inputText.trim() || loading) return;
      if (!modelConfig.apiKey || !modelConfig.model) {
        import_antd.message.warning("\u8BF7\u5148\u5728\u300C\u7CFB\u7EDF\u7BA1\u7406 \u2192 AI \u6A21\u578B\u914D\u7F6E\u300D\u4E2D\u914D\u7F6E\u6A21\u578B");
        return;
      }
    ...
    const doSendMessage = async (userInput) => {
      if (!modelConfig.apiKey || !modelConfig.model) {
        import_antd.message.warning("\u8BF7\u5148\u5728\u300C\u7CFB\u7EDF\u7BA1\u7406 \u2192 AI \u6A21\u578B\u914D\u7F6E\u300D\u4E2D\u914D\u7F6E\u6A21\u578B");
        return;
      }
      ...
      if (activeSessionId && messages.length === 0) {
        ...
        if (session) {
          ...
          const updated = { ...session, name: title, updatedAt: (/* @__PURE__ */ new Date()).toISOString() };
          persistenceManager.saveSession(updated).catch(() => {
          });
      ...
      const server = selectedServer ? servers.find((s) => s.id === selectedServer) : void 0;
      const toolCallStartTimes = /* @__PURE__ */ new Map();
      const segments = [];
      const syncSegments = () => {
      ...
      const removeChunk = window.electronAPI.opsAgent.onChunk(({ requestId: rid, delta }) => {
        ...
        setMessages((prev) => prev.map(
          (m) => m.id === assistantId ? { ...m, content: m.content + delta, segments: [...segments] } : m
        ));
      });
      ...
      const removeToolResult = window.electronAPI.opsAgent.onToolResult(({ requestId: rid, toolName, success, output, toolCallId }) => {
        ...
        const summary = raw.length > 2e3 ? `${raw.slice(0, 2e3)}
... (\u5DF2\u622A\u65AD ${raw.length - 2e3} \u5B57\u7B26)` : raw;
        const now = Date.now();
        for (const seg of segments) {
          ...
          if (matched) {
            const start = toolCallId ? toolCallStartTimes.get(toolCallId) : void 0;
            if (toolCallId) toolCallStartTimes.delete(toolCallId);
            seg.toolCall = { ...seg.toolCall, result: summary, status: success ? "success" : "error", duration: start ? now - start : void 0 };
            break;
          }
        }
        syncSegments();
      });
      const removeRoute = window.electronAPI.opsAgent.onRoute ? window.electronAPI.opsAgent.onRoute(({ requestId: rid, route }) => {
        if (rid !== requestId) return;
        setMessages((prev) => prev.map(
          (m) => m.id === assistantId ? { ...m, metadata: { ...m.metadata || {}, route } } : m
        ));
      }) : () => {
      };
      let reasoningBuf = "";
      const removeReasoning = window.electronAPI.opsAgent.onReasoning ? window.electronAPI.opsAgent.onReasoning(({ requestId: rid, delta }) => {
        if (rid !== requestId) return;
        reasoningBuf += delta;
      ...
      const removeError = window.electronAPI.opsAgent.onError(({ requestId: rid, error }) => {
        ...
        setMessages((prev) => prev.map(
          (m) => m.id === assistantId ? cancelled ? { ...m, status: "success", content: m.content ? `${m.content}

> \u23F9 \u5DF2\u53D6\u6D88\u751F\u6210` : "\u5DF2\u53D6\u6D88\u751F\u6210", segments: [...segments] } : { ...m, status: "error", content: `\u9519\u8BEF: ${error}`, segments: [...segments] } : m
        ));
        setSavePending(true);
      });
      ...
      if (messages.length > HISTORY_KEEP) {
        ...
        if (historySummary.length > 4e3) {
          historySummary = `${historySummary.slice(0, 4e3)}
...\uFF08\u66F4\u65E9\u7684\u5BF9\u8BDD\u5185\u5BB9\u5DF2\u7701\u7565\uFF09`;
        }
      }
      try {
        ...
        if (!result.success) {
          setMessages((prev) => prev.map(
            (m) => m.id === assistantId ? { ...m, status: "error", content: `\u9519\u8BEF: ${result.error}` } : m
          ));
          setSavePending(true);
          setLoading(false);
          cleanup();
...
> \u23F9 \u5DF2\u53D6\u6D88\u751F\u6210` : "\u5DF2\u53D6\u6D88\u751F\u6210" } : { ...m, status: "error", content: `\u9519\u8BEF: ${errMsg}` } : m
        ));
        setSavePending(true);
        setLoading(false);
        cleanup();
    ...
    const executeCommand = async (command, riskLevel) => {
      if (!selectedServer) {
        import_antd.message.warning("\u8BF7\u5148\u9009\u62E9\u670D\u52A1\u5668");
        return null;
      }
    ...
    const executeMessageCommands = async (messageId) => {
    ...
    const analyzeTerminalSelection = () => {
      const term = activeTerminalTab ? terminalInstancesRef.current.get(activeTerminalTab) : void 0;
      const sel = term?.getSelection?.() || "";
      if (!sel.trim()) {
        import_antd.message.info("\u8BF7\u5148\u5728\u7EC8\u7AEF\u4E2D\u9009\u4E2D\u6587\u672C");
        return;
      }
      if (!modelConfig.apiKey || !modelConfig.model) {
        import_antd.message.warning("\u8BF7\u5148\u5728\u300C\u7CFB\u7EDF\u7BA1\u7406 \u2192 AI \u6A21\u578B\u914D\u7F6E\u300D\u4E2D\u914D\u7F6E\u6A21\u578B");
...
\`\`\``);
    ...
    const executeCommandInTerminal = async (command) => {
      if (!selectedServer) {
        import_antd.message.warning("\u8BF7\u5148\u9009\u62E9\u670D\u52A1\u5668");
        return;
      }
      if (!activeTerminalTab) {
        import_antd.message.warning("\u8BF7\u5148\u6253\u5F00\u7EC8\u7AEF");
        return;
      }
      try {
        setActiveTerminalTab(activeTerminalTab);
        await window.electronAPI.terminal.write(activeTerminalTab, command + "\n");
        import_antd.message.success("\u547D\u4EE4\u5DF2\u53D1\u9001\u5230\u7EC8\u7AEF");
      } catch (error) {
        import_antd.message.error(`\u53D1\u9001\u5931\u8D25: ${error.message}`);
      }
    };
    const collectDiagnostics = async (serverId) => {
      ...
      const results = await Promise.all(diagnosticCommands.map(async (diag) => {
        try {
          ...
          switch (diag.type) {
            case "cpu":
              if (value > 90) {
                status = "critical";
                diagMessage = "CPU\u4F7F\u7528\u7387\u8FC7\u9AD8";
                suggestion = "\u5EFA\u8BAE\u68C0\u67E5\u9AD8\u8D1F\u8F7D\u8FDB\u7A0B";
              } else if (value > 70) {
                status = "warning";
                diagMessage = "CPU\u4F7F\u7528\u7387\u8F83\u9AD8";
          ...
          return { type: diag.type, status, value, message: diagMessage, suggestion, timestamp: (/* @__PURE__ */ new Date()).toISOString() };
        } catch {
          return { type: diag.type, status: "critical", value: 0, message: "\u8BCA\u65AD\u5931\u8D25", timestamp: (/* @__PURE__ */ new Date()).toISOString() };
        }
      }));
      return results;
    };
    const runDiagnostics = async () => {
      ...
      try {
        ...
        import_antd.message.error("\u8BCA\u65AD\u5931\u8D25");
      } finally {
    ...
    const runAIAnalysis = async () => {
      ...
      try {
        ...
        if (results.length === 0) {
          import_antd.message.warning("\u672A\u83B7\u53D6\u5230\u8BCA\u65AD\u6570\u636E");
          return;
        }
...
\u8BF7\u4F7F\u7528\u5DE5\u5177\u8FDB\u884C\u6DF1\u5165\u68C0\u67E5\uFF08\u5982\u67E5\u770B\u5BB9\u5668\u72B6\u6001\u3001\u65E5\u5FD7\u3001\u8D44\u6E90\u5360\u7528\u7B49\uFF09\uFF0C\u5B9A\u4F4D\u95EE\u9898\u6839\u56E0\u5E76\u7ED9\u51FA\u53EF\u6267\u884C\u7684\u4FEE\u590D\u6B65\u9AA4\u3002\u9AD8\u98CE\u9669\u64CD\u4F5C\u9700\u8981\u7ECF\u8FC7\u6211\u7684\u786E\u8BA4\u3002`
        ...
        import_antd.message.error("\u667A\u80FD\u8BCA\u65AD\u5931\u8D25");
      } finally {
        setRunningDiagnostics(false);
      }
    };
    ...
    (0, import_react.useEffect)(() => {
      ...
      const deadline = (currentApproval.receivedAt || Date.now()) + timeout * 1e3;
      const updateRemain = () => Math.max(0, Math.round((deadline - Date.now()) / 1e3));
      ...
      const timer = setInterval(() => {
        ...
        if (remain <= 0) {
          ...
          import_antd.message.warning("\u5BA1\u6279\u8D85\u65F6\uFF0C\u64CD\u4F5C\u5DF2\u81EA\u52A8\u62D2\u7EDD");
          setApprovalQueue((q) => q.slice(1));
        }
      }, 1e3);
      return () => clearInterval(timer);
    }, [currentApproval, modelConfig.approvalTimeout]);
    const openNewTerminal = async (targetId, targetName, type) => {
      ...
      try {
        ...
        if (result.success && result.sessionId) {
          ...
          import_antd.message.success("\u7EC8\u7AEF\u5DF2\u6253\u5F00");
        } else {
          import_antd.message.error(result.message || "\u6253\u5F00\u7EC8\u7AEF\u5931\u8D25");
        }
      } catch (error) {
        import_antd.message.error(`\u9519\u8BEF: ${error.message}`);
      }
    };
    const closeTerminalTab = async (sessionId) => {
      try {
...
`);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.ConfigProvider, { theme: { algorithm: import_antd.theme.darkAlgorithm, token: { colorPrimary: "#0A84FF" } }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "agent-terminal-page", style: { display: "flex", flexDirection: "column", height: "100%", background: "#000000", overflow: "hidden" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "agent-terminal-header", style: {
        display: "flex",
        alignItems: "center",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { size: "large", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 34, height: 34, borderRadius: 9, background: "linear-gradient(135deg, rgba(10,132,255,0.18), rgba(10,132,255,0.18))", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid rgba(10,132,255,0.35)", boxShadow: "0 2px 12px rgba(10,132,255,0.12)" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.RobotOutlined, { style: { fontSize: 18, color: "#0A84FF" } }) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Title, { level: 4, className: "agent-terminal-brand", style: { margin: 0, fontSize: 16, lineHeight: 1.2, fontFamily: "inherit", fontWeight: 700 }, children: "AI OPS TERMINAL" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { fontSize: 10, color: "#8e8e93", letterSpacing: 0.6 }, children: "Mastra Agent Console" })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Divider, { type: "vertical", style: { background: "#48484a", height: 28 } }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { size: "small", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CloudOutlined, { style: { color: "#aeaeb2" } }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_antd.Select,
              {
                ...
                options: servers.map((s) => ({
                  value: s.id,
                  label: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Badge, { status: s.status === "online" ? "success" : "default" }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#f5f5f7" }, children: s.name }),
            ...
            connected && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tag, { color: "success", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.LinkOutlined, {}), style: { border: "1px solid rgba(63,185,80,0.4)", background: "rgba(63,185,80,0.1)" }, children: "\u5DF2\u8FDE\u63A5" })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { size: "middle", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { size: 6, style: { padding: "4px 12px", background: "rgba(44,44,46,0.8)", borderRadius: 999, border: "1px solid #3a3a3c" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.DashboardOutlined, { style: { color: "#0A84FF", fontSize: 11 } }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, { style: { color: "#aeaeb2", fontSize: 11 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { strong: true, style: { color: "#f5f5f7", fontSize: 11 }, children: stats.totalCommands }),
              " \u547D\u4EE4",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { margin: "0 6px", color: "#48484a" }, children: "|" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, { strong: true, style: { color: stats.successRate >= 90 ? "#30D158" : stats.successRate >= 60 ? "#FF9500" : "#FF453A", fontSize: 11 }, children: [
                stats.successRate,
                "%"
              ] }),
              " \u6210\u529F"
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tag, { color: modelConfig.apiKey && modelConfig.model ? "success" : "default", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.ApiOutlined, {}), style: { border: "1px solid rgba(63,185,80,0.35)", background: "rgba(63,185,80,0.08)", maxWidth: 160, overflow: "hidden", textOverflow: "ellipsis" }, children: modelConfig.model || "\u672A\u914D\u7F6E" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title: "\u6A21\u578B\u914D\u7F6E\u5DF2\u79FB\u81F3 \u7CFB\u7EDF\u7BA1\u7406", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.SettingOutlined, {}), disabled: true }) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title: sidebarCollapsed ? "\u5C55\u5F00\u4FA7\u8FB9\u680F" : "\u6536\u8D77\u4FA7\u8FB9\u680F", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", icon: sidebarCollapsed ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.MenuUnfoldOutlined, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.MenuFoldOutlined, {}), onClick: () => setSidebarCollapsed(!sidebarCollapsed) }) })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "agent-main-content", style: { flex: 1, display: "flex", minHeight: 0, overflow: "hidden" }, children: [
        !sidebarCollapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "agent-sidebar", style: { width: 200, flexShrink: 0, display: "flex", flexDirection: "column", borderRight: "1px solid rgba(72,72,74,0.8)", background: "rgba(0,0,0,0.55)", minHeight: 0 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "9px 14px", height: 46, boxSizing: "border-box", background: "rgba(28,28,30,0.7)", backdropFilter: "blur(20px) saturate(180%)", borderBottom: "1px solid #48484a", flexShrink: 0 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 26, height: 26, borderRadius: 7, background: "rgba(10,132,255,0.12)", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid rgba(10,132,255,0.25)" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.MessageOutlined, { style: { color: "#0A84FF", fontSize: 13 } }) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, { strong: true, style: { color: "#f5f5f7", fontSize: 12 }, children: [
                "\u5BF9\u8BDD (",
                sessions.length,
                ")"
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", type: "text", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.PlusOutlined, {}), onClick: createSession, title: "\u65B0\u5EFA\u5BF9\u8BDD", style: { color: "#0A84FF", padding: 0, width: 24, height: 24 } })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { padding: "6px 8px" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_antd.Input,
            {
              size: "small",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, overflow: "auto", padding: "0 6px 8px" }, children: [
            filteredSessions.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "div",
              {
                className: `agent-sidebar-item ${activeSessionId === s.id ? "active" : ""}`,
                onClick: () => setActiveSessionId(s.id),
                style: { display: "flex", alignItems: "center", gap: 8, padding: "7px 8px", borderRadius: 8, cursor: "pointer" },
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.MessageOutlined, { style: { color: activeSessionId === s.id ? "#0A84FF" : "#8e8e93", fontSize: 12, flexShrink: 0 } }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, minWidth: 0 }, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: activeSessionId === s.id ? "#f5f5f7" : "#aeaeb2", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: s.name }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 10, color: "#8e8e93" }, children: [
                      s.messages.length,
                      " \u6761\u6D88\u606F"
                    ] })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { size: 2, className: "agent-sidebar-actions", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      import_antd.Button,
                      {
                        size: "small",
                        ...
                        title: "\u590D\u5236\u4F1A\u8BDD",
                        style: { color: "#aeaeb2", padding: 0, width: 20, height: 20 },
                        onClick: (e) => {
                          e.stopPropagation();
            ...
            filteredSessions.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { textAlign: "center", padding: "24px 0" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { fontSize: 11, color: "#8e8e93" }, children: sessionSearch ? "\u672A\u627E\u5230\u5339\u914D\u4F1A\u8BDD" : "\u6682\u65E0\u4F1A\u8BDD\uFF0C\u70B9\u51FB + \u65B0\u5EFA" }) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: "10px 12px", borderTop: "1px solid rgba(72,72,74,0.8)" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { fontSize: 10, color: "#aeaeb2", letterSpacing: 1.2 }, children: "\u6536\u85CF\u547D\u4EE4" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 8, display: "flex", flexDirection: "column", gap: 4 }, children: [
              favorites.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "div",
                {
                  className: "agent-sidebar-item",
                  onClick: () => setInputText(f.command),
                  style: { display: "flex", alignItems: "center", gap: 8, padding: "6px 8px", borderRadius: 8, cursor: "pointer" },
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.StarOutlined, { style: { color: "#FF9500", fontSize: 11, flexShrink: 0 } }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1, minWidth: 0, fontSize: 11, color: "#aeaeb2", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontFamily: "Consolas, monospace" }, children: f.command }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      import_antd.Button,
                      {
                        size: "small",
                        type: "text",
                        icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CloseOutlined, {}),
                        title: "\u53D6\u6D88\u6536\u85CF",
                        style: { padding: 0, width: 16, height: 16, color: "#8e8e93" },
                        onClick: (e) => {
                          e.stopPropagation();
                          toggleFavoriteCommand(f.command, f.name);
                        }
                      }
                    )
                  ]
              ...
              favorites.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { fontSize: 11, color: "#8e8e93", padding: "4px 8px" }, children: "\u6682\u65E0\u6536\u85CF\uFF0C\u70B9\u51FB\u5DE5\u5177\u5361\u7247\u661F\u6807\u6DFB\u52A0" })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: "10px 12px", borderTop: "1px solid rgba(72,72,74,0.8)" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { fontSize: 10, color: "#aeaeb2", letterSpacing: 1.2 }, children: "\u670D\u52A1\u5668" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 8, display: "flex", flexDirection: "column", gap: 4 }, children: [
              servers.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "div",
                {
                  className: `agent-sidebar-item ${selectedServer === s.id ? "active" : ""}`,
                  onClick: () => handleServerChange(s.id),
                  style: { display: "flex", alignItems: "center", gap: 8, padding: "6px 8px", borderRadius: 8, cursor: "pointer" },
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { width: 7, height: 7, borderRadius: "50%", background: s.status === "online" ? "#30D158" : "#636366", flexShrink: 0, boxShadow: s.status === "online" ? "0 0 5px rgba(63,185,80,0.6)" : "none" } }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, minWidth: 0 }, children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: selectedServer === s.id ? "#f5f5f7" : "#aeaeb2", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: s.name }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 10, color: "#8e8e93", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: s.host })
                    ] }),
                    selectedServer === s.id && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.LinkOutlined, { style: { color: "#0A84FF", fontSize: 11 } })
                  ]
                },
                s.id
              )),
              servers.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { fontSize: 11, color: "#8e8e93", padding: "4px 8px" }, children: "\u6682\u65E0\u5728\u7EBF\u670D\u52A1\u5668" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, height: "100%", display: "flex", flexDirection: "column", borderRight: "1px solid rgba(72,72,74,0.7)", overflow: "hidden", minHeight: 0 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "9px 14px", height: 46, boxSizing: "border-box", background: "rgba(28,28,30,0.7)", backdropFilter: "blur(20px) saturate(180%)", borderBottom: "1px solid #48484a", flexShrink: 0 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 26, height: 26, borderRadius: 7, background: "rgba(10,132,255,0.12)", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid rgba(10,132,255,0.25)" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.LaptopOutlined, { style: { color: "#0A84FF", fontSize: 13 } }) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { strong: true, style: { color: "#f5f5f7", fontSize: 12 }, children: "\u7EC8\u7AEF" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 4, marginLeft: 8, background: "#000000", borderRadius: 6, padding: 2, border: "1px solid #3a3a3c" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", type: "text", onClick: () => setTerminalMode("server"), style: terminalMode === "server" ? { background: "#3a3a3c", color: "#0A84FF", borderRadius: 4, fontSize: 11 } : { color: "#aeaeb2", fontSize: 11, borderRadius: 4 }, children: "\u670D\u52A1\u5668" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", type: "text", onClick: () => setTerminalMode("container"), style: terminalMode === "container" ? { background: "#3a3a3c", color: "#0A84FF", borderRadius: 4, fontSize: 11 } : { color: "#aeaeb2", fontSize: 11, borderRadius: 4 }, children: "\u5BB9\u5668" })
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { size: "small", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title: "AI \u5206\u6790\u7EC8\u7AEF\u9009\u4E2D\u5185\u5BB9", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_antd.Button,
                {
                  size: "small",
                  icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.RobotOutlined, {}),
                  onClick: analyzeTerminalSelection,
                  style: { borderColor: "#48484a", color: "#0A84FF" }
                }
              ) }),
              terminalMode === "container" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.ReloadOutlined, {}), onClick: () => selectedServer && loadContainers(selectedServer), disabled: !selectedServer, children: "\u5237\u65B0" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_antd.Button,
                {
                  size: "small",
                  ...
                  onClick: () => {
                    ...
                    if (terminalMode === "container") {
                      if (containers.length === 0) {
                        import_antd.message.warning("\u6CA1\u6709\u53EF\u7528\u5BB9\u5668");
                        return;
                      }
                      setSelectedContainerId(void 0);
                  ...
                  style: { background: "linear-gradient(135deg, #0A84FF 0%, #0051D5 100%)", borderColor: "transparent", boxShadow: "0 2px 10px rgba(10,132,255,0.3)" },
                  children: "\u65B0\u5EFA\u7EC8\u7AEF"
                }
              )
            ] })
          ] }),
          terminalTabs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", background: "transparent" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_antd.Empty,
            {
              image: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.LaptopOutlined, { style: { fontSize: 44, color: "#636366" } }),
              description: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: "#aeaeb2" }, children: [
                "\u9009\u62E9 ",
                terminalMode === "server" ? "\u670D\u52A1\u5668" : "\u5BB9\u5668",
                " \u6253\u5F00\u7EC8\u7AEF"
              ] })
            }
          ) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", background: "rgba(28,28,30,0.85)", borderBottom: "1px solid #48484a", overflowX: "auto" }, children: terminalTabs.map((tab) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "div",
              {
                onClick: () => setActiveTerminalTab(tab.sessionId),
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { display: "inline-block", width: 8, height: 8, borderRadius: "50%", background: activeTerminalTab === tab.sessionId ? "#30D158" : "#48484a", boxShadow: activeTerminalTab === tab.sessionId ? "0 0 6px rgba(63,185,80,0.7)" : "none" } }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { maxWidth: 100, overflow: "hidden", textOverflow: "ellipsis", color: activeTerminalTab === tab.sessionId ? "#f5f5f7" : "#aeaeb2" }, children: tab.containerName }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CloseOutlined, { style: { fontSize: 10, color: "#8e8e93", transition: "color .15s" }, onClick: (e) => {
                    e.stopPropagation();
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: terminalAreaRef, style: { flex: 1, minHeight: 0, overflow: "hidden", position: "relative" }, children: terminalTabs.map((tab) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: activeTerminalTab === tab.sessionId ? "block" : "none", position: "absolute", inset: 0, background: "#000000" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: (el) => {
              if (el) terminalContainersRef.current.set(tab.sessionId, el);
            }, style: { width: "100%", height: "100%" } }) }, tab.sessionId)) })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "agent-chat-panel", style: { width: 480, minWidth: 420, maxWidth: "35%", height: "100%", display: "flex", flexDirection: "column", background: "#000000", overflow: "hidden" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "9px 14px", height: 46, boxSizing: "border-box", background: "rgba(28,28,30,0.7)", backdropFilter: "blur(20px) saturate(180%)", borderBottom: "1px solid #48484a", flexShrink: 0 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 26, height: 26, borderRadius: 7, background: "linear-gradient(135deg, rgba(10,132,255,0.16), rgba(88,166,255,0.16))", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid rgba(10,132,255,0.3)" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.RobotOutlined, { style: { color: "#0A84FF", fontSize: 13 } }) }),
              activeSessionId && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title: sessions.find((s) => s.id === activeSessionId)?.name, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tag, { style: { margin: 0, fontSize: 11, background: "rgba(88,166,255,0.12)", border: "1px solid rgba(88,166,255,0.35)", color: "#0A84FF", borderRadius: 999, maxWidth: 220 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { display: "inline-block", maxWidth: 170, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", verticalAlign: "middle", color: "#0A84FF" }, children: sessions.find((s) => s.id === activeSessionId)?.name }) }) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_antd.Select,
                {
                  value: modelConfig.activeProfileId,
                  onChange: (v) => activateProfile(v),
                  size: "small",
                  variant: "borderless",
                  style: { minWidth: 96, fontSize: 11, color: "#aeaeb2" },
                  suffixIcon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.ThunderboltOutlined, { style: { color: "#0A84FF", fontSize: 10 } }),
                  options: (modelConfig.providerProfiles || []).map((p) => ({ value: p.id, label: `${p.name} \xB7 ${p.model || "\u672A\u9009\u6A21\u578B"}` }))
                }
              )
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { size: 2, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title: "\u7CFB\u7EDF\u8BCA\u65AD", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", type: "text", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.ScanOutlined, {}), onClick: runDiagnostics, loading: runningDiagnostics, style: { color: "#aeaeb2" } }) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title: "\u547D\u4EE4\u5386\u53F2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", type: "text", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.HistoryOutlined, {}), onClick: () => setShowHistory(true), style: { color: "#aeaeb2" } }) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title: "\u65B0\u5EFA\u5BF9\u8BDD", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", type: "text", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.PlusOutlined, {}), onClick: createSession, style: { color: "#aeaeb2" } }) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title: "\u6E05\u7A7A\u5BF9\u8BDD", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { size: "small", type: "text", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.ClearOutlined, {}), onClick: clearMessages, disabled: messages.length === 0 }) })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: messagesRef, className: "agent-messages", style: { flex: 1, minHeight: 0, overflow: "auto", padding: 16 }, children: messages.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { textAlign: "center", padding: "60px 0" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 76, height: 76, margin: "0 auto 20px", borderRadius: 20, background: "radial-gradient(circle at 30% 30%, rgba(10,132,255,0.25), rgba(88,166,255,0.08) 70%)", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid rgba(10,132,255,0.2)", animation: "glow-pulse 3.2s ease-in-out infinite" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.RobotOutlined, { style: { fontSize: 32, color: "#0A84FF" } }) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { color: "#f5f5f7", fontSize: 15, fontWeight: 600, display: "block" }, children: "\u5F00\u59CB\u4E0E AI \u5BF9\u8BDD\uFF0C\u7BA1\u7406\u4F60\u7684\u670D\u52A1\u5668" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { type: "secondary", style: { color: "#8e8e93", fontSize: 12, display: "block", marginTop: 6 }, children: "\u652F\u6301\u5DE5\u5177\u8C03\u7528 \xB7 \u667A\u80FD\u8BCA\u65AD \xB7 \u98CE\u9669\u5BA1\u6279" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 28 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { color: "#aeaeb2", fontSize: 11, marginBottom: 12, display: "block", letterSpacing: 1 }, children: "\u5FEB\u6377\u547D\u4EE4" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Space, { wrap: true, size: [8, 8], style: { width: "100%" }, children: (modelConfig.quickMessages && modelConfig.quickMessages.length > 0 ? modelConfig.quickMessages : [
                "\u8BF7\u5BF9\u5F53\u524D\u670D\u52A1\u5668\u505A\u4E00\u6B21\u7EFC\u5408\u5065\u5EB7\u68C0\u67E5",
                "\u5217\u51FA\u5F53\u524D\u670D\u52A1\u5668\u4E0A\u8FD0\u884C\u7684\u6240\u6709 Docker \u5BB9\u5668",
                "\u67E5\u770B\u670D\u52A1\u5668 CPU\u3001\u5185\u5B58\u3001\u78C1\u76D8\u4F7F\u7528\u7387"
              ]).map((tip, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Tag, { className: "quick-tip", onClick: () => setInputText(tip), style: { maxWidth: "100%", whiteSpace: "normal", height: "auto", lineHeight: "20px", padding: "4px 12px", textAlign: "left" }, children: [
                tip.slice(0, 20),
                tip.length > 20 ? "\u2026" : ""
              ] }, i)) })
            ] })
          ] }) : messages.map((msg) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginBottom: 16, display: "flex", justifyContent: msg.role === "user" ? "flex-end" : "flex-start" }, children: [
            msg.role === "user" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "user-msg-bubble", style: { maxWidth: "85%", padding: "10px 14px", background: "linear-gradient(135deg, #0A84FF 0%, #0051D5 100%)", color: "#fff" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13, whiteSpace: "pre-wrap" }, children: msg.content }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 10, color: "rgba(255,255,255,0.6)", marginTop: 4 }, children: new Date(msg.timestamp).toLocaleTimeString() })
            ] }),
            msg.role === "assistant" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { maxWidth: "92%", display: "flex", gap: 10, alignItems: "flex-start" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ai-avatar", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.RobotOutlined, { style: { color: "#fff", fontSize: 13 } }) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1, minWidth: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ai-msg-bubble", style: { padding: msg.status === "running" ? "10px 14px" : "12px 14px" }, children: [
                !!msg.reasoning && msg.reasoning.trim().length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  import_antd.Collapse,
                  {
                    ...
                    items: [{
                      key: "reasoning",
                      label: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 11, color: "#8e8e93" }, children: "\u{1F4AD} \u601D\u8003\u8FC7\u7A0B" }),
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { style: { margin: 0, whiteSpace: "pre-wrap", fontSize: 12, color: "#aeaeb2" }, children: msg.reasoning })
                    }]
                  }
                ),
                msg.segments && msg.segments.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
                  msg.segments.map((seg, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: seg.type === "text" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13, lineHeight: 1.65, color: "#f5f5f7" }, children: renderRichSegment(seg.text, (cmd) => {
                    navigator.clipboard.writeText(cmd);
                    import_antd.message.success("\u5DF2\u590D\u5236");
                  }, executeCommandInTerminal, !!activeTerminalTab) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToolCallCard, { tc: seg.toolCall }) }, idx)),
                  msg.status === "running" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "typing-dots", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", {}),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", {}),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", {})
                  ] })
                ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", alignItems: "flex-start" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, { style: { color: "#f5f5f7", fontSize: 13, whiteSpace: "pre-wrap", lineHeight: 1.6 }, children: [
                    msg.content || "\u601D\u8003\u4E2D",
                    msg.status === "running" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "typing-dots", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", {}),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", {}),
                  ...
                  msg.toolCalls && msg.toolCalls.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Space, { direction: "vertical", size: 6, style: { width: "100%", marginTop: 12 }, children: msg.toolCalls.map((tc, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToolCallCard, { tc }, idx)) })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 10, color: "#8e8e93", marginTop: 10, display: "flex", alignItems: "center", gap: 8 }, children: [
                  new Date(msg.timestamp).toLocaleTimeString(),
                  msg.metadata?.executionTime && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
                    "\u23F1 ",
                    msg.metadata.executionTime,
                    "ms"
                  ] }),
                  msg.metadata?.route && msg.metadata.route !== "execution" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tag, { color: ROUTE_META[msg.metadata.route]?.color || "default", style: { fontSize: 10, margin: 0, borderRadius: 999 }, children: ROUTE_META[msg.metadata.route]?.label || msg.metadata.route }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { flex: 1 } }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title: "\u590D\u5236\u56DE\u590D", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    import_antd.Button,
                    {
                      size: "small",
                      type: "text",
                      icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CopyOutlined, {}),
                      style: { color: "#8e8e93", padding: 0, width: 20, height: 20 },
                      onClick: () => {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "agent-input", style: { padding: 14, borderTop: "1px solid rgba(72,72,74,0.8)", background: "rgba(28,28,30,0.85)", flexShrink: 0 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "stretch", gap: 0 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                TextArea,
                {
                  ref: inputRef,
              ...
              loading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tooltip, { title: "\u505C\u6B62\u751F\u6210", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                import_antd.Button,
                {
                  icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CloseOutlined, {}),
                  onClick: () => {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                ...
                {
                  type: "primary",
                  icon: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.LoadingOutlined, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.SendOutlined, {}),
                  onClick: sendMessage,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 6, padding: "0 2px" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { fontSize: 10, color: "#8e8e93" }, children: "Enter \u53D1\u9001 \xB7 Shift+Enter \u6362\u884C" }),
              selectedServer && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, { style: { fontSize: 10, color: "#30D158" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.LinkOutlined, { style: { marginRight: 3 } }),
                "\u5DF2\u8FDE\u63A5 ",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        import_antd.Modal,
        {
          title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.LaptopOutlined, { style: { color: "#0A84FF" } }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#f5f5f7" }, children: "\u6253\u5F00\u5BB9\u5668\u7EC8\u7AEF" })
          ] }),
          open: openNewModal,
          onOk: () => {
            if (selectedContainerId) {
              const c = containers.find((x) => x.id === selectedContainerId);
              if (c) openNewTerminal(c.id, c.name, "container");
            }
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            import_antd.Select,
            {
              ...
              options: containers.map((c) => ({ value: c.id, label: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#f5f5f7" }, children: c.name }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tag, { color: "blue", style: { borderRadius: 999 }, children: c.image }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Tag, { color: c.status.includes("running") ? "green" : "default", style: { borderRadius: 999 }, children: c.status })
              ] }) }))
            }
          )
        }
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        {
          title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.ScanOutlined, { style: { color: "#0A84FF" } }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#f5f5f7" }, children: "\u7CFB\u7EDF\u8BCA\u65AD\u62A5\u544A" })
          ] }),
          open: showDiagnostics,
          onCancel: () => setShowDiagnostics(false),
          width: 600,
          footer: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Button, { type: "primary", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.ThunderboltFilled, {}), loading: runningDiagnostics, onClick: runAIAnalysis, style: { background: "linear-gradient(135deg, #0A84FF 0%, #0051D5 100%)", borderColor: "transparent" }, children: "AI \u6DF1\u5165\u5206\u6790\u5E76\u4FEE\u590D" }),
          styles: { body: { background: "#1c1c1e" }, content: { background: "#1c1c1e", border: "1px solid #48484a" }, header: { background: "#1c1c1e", borderBottom: "1px solid #3a3a3c" } },
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Space, { direction: "vertical", style: { width: "100%" }, size: "middle", children: diagnostics.map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.Card, { size: "small", style: { background: "rgba(0,0,0,0.8)", border: "1px solid #3a3a3c", borderRadius: 10 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
            d.status === "healthy" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CheckCircleOutlined, { style: { color: "#30D158", fontSize: 16 } }),
            d.status === "warning" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.ExclamationCircleOutlined, { style: { color: "#FF9500", fontSize: 16 } }),
            d.status === "critical" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CloseCircleOutlined, { style: { color: "#FF453A", fontSize: 16 } }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { strong: true, style: { color: "#f5f5f7", textTransform: "capitalize" }, children: d.type }),
              (d.type === "cpu" || d.type === "memory" || d.type === "disk") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, { style: { color: "#0A84FF", fontSize: 13, fontWeight: 600 }, children: [
                " ",
                d.value,
                "%"
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { color: "#aeaeb2", fontSize: 12 }, children: d.message }) }),
              d.suggestion && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, { style: { color: "#FF9500", fontSize: 11 }, children: [
                "\u{1F4A1} ",
                d.suggestion
              ] }) })
            ] })
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        {
          title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.HistoryOutlined, { style: { color: "#0A84FF" } }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#f5f5f7" }, children: "\u547D\u4EE4\u5386\u53F2" })
          ] }),
          open: showHistory,
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.List, { dataSource: commandHistory.slice(0, 50), renderItem: (item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_antd.List.Item, { style: { borderBottom: "1px solid #3a3a3c", padding: "8px 0" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { width: "100%" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { style: { width: "100%", justifyContent: "space-between" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { code: true, style: { color: "#30D158", fontSize: 12, background: "rgba(0,0,0,0.6)", padding: "2px 8px", borderRadius: 4, fontFamily: "Consolas, monospace" }, children: item.command }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { size: 8, children: [
                item.success ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CheckCircleOutlined, { style: { color: "#30D158" } }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.CloseCircleOutlined, { style: { color: "#FF453A" } }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Text, { type: "secondary", style: { fontSize: 11 }, children: [
                  item.executionTime,
                  "ms"
                ] })
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { type: "secondary", style: { fontSize: 11 }, children: new Date(item.timestamp).toLocaleString() }) })
          ] }) }) })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        {
          title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.SafetyOutlined, { style: { color: "#FF9500" } }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#f5f5f7" }, children: "\u5B89\u5168\u5BA1\u6279" }),
            approvalQueue.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Tag, { color: "orange", style: { fontSize: 10, margin: 0 }, children: [
              "\u961F\u5217 ",
          ...
          onOk: () => handleApproval(true),
          okText: "\u786E\u8BA4\u6267\u884C",
          cancelText: "\u53D6\u6D88",
          okButtonProps: { danger: currentApproval?.riskLevel === "high" },
          styles: { body: { background: "#1c1c1e" }, content: { background: "#1c1c1e", border: "1px solid #48484a" }, header: { background: "#1c1c1e", borderBottom: "1px solid #3a3a3c" } },
          children: currentApproval && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              import_antd.Alert,
              {
                message: `\u98CE\u9669\u7B49\u7EA7: ${currentApproval.riskLevel === "high" ? "\u9AD8\u98CE\u9669" : "\u4E2D\u98CE\u9669"}`,
                type: currentApproval.riskLevel === "high" ? "error" : "warning",
                showIcon: true,
                style: { marginBottom: 16, borderRadius: 8 },
                action: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: approvalCountdown <= 10 ? "#FF453A" : "#aeaeb2", fontSize: 12, fontWeight: 600 }, children: [
                  approvalCountdown,
                  "s"
                ] })
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, { style: { color: "#aeaeb2", fontSize: 11, display: "block", marginBottom: 6 }, children: "\u6267\u884C\u547D\u4EE4" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { style: { background: "rgba(0,0,0,0.85)", padding: 12, borderRadius: 8, color: "#FF453A", border: "1px solid rgba(255,123,114,0.3)", fontFamily: "Consolas, monospace", fontSize: 12, whiteSpace: "pre-wrap" }, children: currentApproval.action })
          ] })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        {
          title: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_antd.Space, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_icons.EditOutlined, { style: { color: "#0A84FF" } }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#f5f5f7" }, children: "\u91CD\u547D\u540D\u4F1A\u8BDD" })
          ] }),
          open: !!renameTarget,
          onOk: renameSession,
  ...
  var AgentTerminal_default = AgentTerminalPage;
})();
